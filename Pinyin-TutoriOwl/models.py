...
def Conv2D(N_CLASSES=56, SR=48000, DT=1.0):
    ...
    x = layers.Conv2D(16, kernel_size=(7,7), activation='relu', padding='same', name='conv2d_relu_1')(x)
    x = layers.MaxPooling2D(pool_size=(2,2), padding='same', name='max_pool_2d_2')(x)
    x = layers.Conv2D(16, kernel_size=(7,7), activation='relu', padding='same', name='conv2d_relu_2')(x)
