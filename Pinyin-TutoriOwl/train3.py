...
def create_tflite_compatible_model(weights, input_shape, N_CLASSES=56):
    ...
    model_tflite.add(layers.Conv2D(16, kernel_size=(7, 7), activation='tanh', padding='same', name='td_conv_2d_tanh'))
    model_tflite.add(layers.MaxPooling2D(pool_size=(3, 3), padding='same', name='max_pool_2d_1'))
    model_tflite.add(layers.Conv2D(32, kernel_size=(5, 5), activation='relu', padding='same', name='conv2d_relu_2'))
    model_tflite.add(layers.MaxPooling2D(pool_size=(3, 3), padding='same', name='max_pool_2d_6'))
    model_tflite.add(layers.Conv2D(32, kernel_size=(3, 3), activation='relu', padding='same', name='conv2d_relu_3'))
    model_tflite.add(layers.MaxPooling2D(pool_size=(3, 3), padding='same', name='max_pool_2d_2'))
    model_tflite.add(layers.Conv2D(64, kernel_size=(3, 3), activation='relu', padding='same', name='conv2d_relu_4'))
    model_tflite.add(layers.AveragePooling2D(pool_size=(2, 2), padding='same', name='max_pool_2d_7'))
    ...
    model_tflite.add(layers.Conv2D(128, kernel_size=(3, 3), activation='relu', padding='same', name='conv2d_relu_7'))
    model_tflite.add(layers.MaxPooling2D(pool_size=(2, 2), padding='same', name='max_pool_2d_5'))
    model_tflite.add(layers.Dropout(rate=0.3))
